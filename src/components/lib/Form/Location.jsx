...
const Location = () => {
    ...
    const onSubmit = (values) => {
        ...
        if (Enc) {
            ...
            const locationData = [{ ...decryptedData, ...values }]
    ...
    return (
        <div className='p-5'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                    <option selected={fLocation == "東京 A" ? true : false} value="東京 A">東京 A</option>
                    <option selected={fLocation == "横浜 B" ? true : false} value="横浜 B">横浜 B</option>
                </select>
                <br />
                <br />
                ...
                >
                    <option selected={tLocation == "名古屋 C" ? true : false} value="名古屋 C">名古屋 C</option>
                    <option selected={tLocation == "大阪 D" ? true : false} value="大阪 D">大阪 D</option>
                </select>
                <br /><br />
